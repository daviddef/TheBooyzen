# Drafted — Anne Brest, on the invoice and Tuesday

**Status: DRAFTED, NOT SENT — 20 September 2026.** Sending is David's, and so is the choice
between the two options in it. **Send something today.** Tuesday is 22 September, she has
already arranged the files, and she is waiting on a proof of payment.

**The one thing that would be wrong is silence.** She has been straight from the first message
— she volunteered a cap on her own fees unasked, and gave a seventh file free. A researcher
who has booked a day and ordered files deserves to know where she stands before she drives to
Pretoria.
...
- **TAB MHG 3734/46 — DASCHNER, Catherine Mary Sophia, born Booyzen** — the one I most need,
  for her parents
...
That third one is not on Invoice 463. **I am asking for it in place of one of the others, not
in addition to them** — research since I last wrote has made it the most valuable single page
on my whole list, and I would rather drop two Booyzen files than lose it. If adding it to the
requisitions at this stage is a nuisance, leave it and I will ask for it another time.

**And please treat everything in my long email of 16 September — the further groups A, B and C
— as withdrawn for now.** That was me getting ahead of myself. I do not want you working on
anything that is not on an invoice I have paid.

Whichever you choose, I am grateful. You have been straight with me from the first message,
you volunteered a cap on your own fees before I asked for one, and you gave me a file for
nothing. **I would like to still be working with you in six months**, and that matters more to
me than getting these particular files this particular week.
